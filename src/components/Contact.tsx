...
import { Mail, Phone, MapPin, Send, Twitter, Instagram, Youtube, Twitch } from 'lucide-react';
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      details: 'contact@xset.com',
      description: 'General inquiries and support'
    },
    {
      icon: Mail,
      title: 'Business',
      details: 'partnerships@xset.com',
      description: 'Partnership and sponsorship opportunities'
    },
    {
      icon: Mail,
      title: 'Media',
      details: 'media@xset.com',
    ...
    },
    {
      ...
      description: 'Headquarters and training facility'
    }
  ];

  const socialLinks = [
    { icon: Twitter, name: 'Twitter', handle: '@XSET', url: '#' },
    { icon: Instagram, name: 'Instagram', handle: '@xsetgaming', url: '#' },
    { icon: Youtube, name: 'YouTube', handle: 'XSET', url: '#' },
    { icon: Twitch, name: 'Twitch', handle: 'xsetgaming', url: '#' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            {/* Office Hours */}
            <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-xl p-6 border border-blue-500/20">
